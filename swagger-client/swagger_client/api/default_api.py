...
class DefaultApi(object):
    ...
    def create_access_token_user_signup_post(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            return self.create_access_token_user_signup_post_with_http_info(
                body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.create_access_token_user_signup_post_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data

    def create_access_token_user_signup_post_with_http_info(
        self, body, **kwargs
    ):  # noqa: E501
        """Create Access Token  # noqa: E501
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `create_access_token_user_signup_post`"
            )  # noqa: E501
